...
select (select count(*) from historico_status_laptop_f1) as historico_status_laptop_f1,
       ...
       (select count(*) from tipo_almacenamiento_f1)     as tipo_almacenamiento_f1,
       (select count(*) from tipo_almacenamiento_f2)     as tipo_almacenamiento_f2,
       (select count(*) from tipo_almacenamiento_f3)     as tipo_almacenamiento_f3,
       (select count(*) from tipo_almacenamiento_f4)     as tipo_almacenamiento_f4,
       (select count(*) from tipo_monitor_f1)            as tipo_monitor_f1,
       (select count(*) from tipo_monitor_f2)            as tipo_monitor_f2,
       (select count(*) from tipo_monitor_f3)            as tipo_monitor_f3,
       (select count(*) from tipo_monitor_f4)            as tipo_monitor_f4,
       (select count(*) from tipo_procesador_f1)         as tipo_procesador_f1,
       (select count(*) from tipo_procesador_f2)         as tipo_procesador_f2,
       (select count(*) from tipo_procesador_f3)         as tipo_procesador_f3,
       (select count(*) from tipo_procesador_f4)         as tipo_procesador_f4,
       (select count(*) from tipo_tarjeta_video_f1)      as tipo_tarjeta_video_f1,
       (select count(*) from tipo_tarjeta_video_f2)      as tipo_tarjeta_video_f2,
       (select count(*) from tipo_tarjeta_video_f3)      as tipo_tarjeta_video_f3,
       (select count(*) from tipo_tarjeta_video_f4)      as tipo_tarjeta_video_f4
from dual;