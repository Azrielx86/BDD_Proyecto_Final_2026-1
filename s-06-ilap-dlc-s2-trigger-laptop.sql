create
    or replace trigger t_dml_laptop
    ...
    case
        when inserting then
            if substr(:new.num_serie, 1, 1) between '0' and '1' then
                ...
                substr(:new.num_serie, 1, 1) between '2' and '3' then
                ...
                substr(:new.num_serie, 1, 1) between '4' and '5' then
                ...
                substr(:new.num_serie, 1, 1) between '6' and '9' then
        ...
        when deleting then
            if substr(:old.num_serie, 1, 1) between '0' and '1' then
                ...
                substr(:old.num_serie, 1, 1) between '2' and '3' then
                delete
                from laptop_f2
                where laptop_id = :old.laptop_id;
            elsif
                substr(:old.num_serie, 1, 1) between '4' and '5' then
                delete
                from laptop_f3
                where laptop_id = :old.laptop_id;
            elsif
                substr(:old.num_serie, 1, 1) between '6' and '9' then
                delete
                from laptop_f4
                where laptop_id = :old.laptop_id;
            else
